...
export class ScrollVanishDirective implements OnInit {
  ...
  initStyles() {
    this.domCtrl.write(() => {
      ...
      // this.renderer.setStyle(this.element.nativeElement, 'height', '98px');
  ...
  hide() {
    this.domCtrl.write(() => {
      ...
      // this.renderer.setStyle(this.element.nativeElement, 'height', '54px');
      this.renderer.setStyle(this.element.nativeElement, 'margin-top', '-54px');
